...
#define MOVE_ACCURACY 0.15  //≈сли рассто€ние до заданной цели меньше этого параметра, то считаем, что робот приехал в заданную точку
#define TURN_ACCURACY 0.1  //≈сли отклонение текущего угла от заданного меньше этого параметра, то считаем, что робот направлен в сторону заданной цели; единица - радиан
